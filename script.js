...
document.querySelectorAll('a') // GA Solution

// TODO: [6] Select all the quotes in the "life" section.
document.querySelector('.life')
document.querySelector('.life').querySelectorAll('.quote') // GA Solution

// TODO: [7] Using relative selection, select the <p> element containing the second Mark Twain quote
document.getElementById('mark-twain-second') // direct
document.querySelector('#mark-twain-second > p') // relative
document.body.children[1].children[1].children[2].children[0].children[0] // GA Solution

// TODO: [8] Do the same using a query selector
document.querySelector('#mark-twain-second')
document.querySelector('#mark-twain-second').querySelector('p') // GA Solution

// TODO: [9] Select the 'Quotes About Motivation' heading
document.querySelector('.motivation > h2')
ocument.querySelectorAll('h2')[2] //GA Solution
